...
import Images from './componentImage';
import "./index.css"
...
function Session2() {
  ...
  return (
    <div className="card">
        <Images src={data.album.images[0].url} />
        <Welcome name={data.name}/>
        <Welcome name={data.artists[0].name}/>
        <Welcome text={data.album.release_date}/>
        <Welcome text={data.type}/>
